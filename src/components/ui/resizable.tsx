...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-10 w-10 -ml-5 items-center justify-center rounded-full bg-gradient-to-r from-[#5BC77E] to-[#5BC77E] shadow-md hover:opacity-90 transition-opacity">
        <img 
